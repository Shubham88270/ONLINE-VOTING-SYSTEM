            ...
            <div className="flex items-center gap-4 mb-5">
              ...
              <div>
                ...
                <span
                  ...
                  style={{ background: 'rgba(99,102,241,0.15)', color: 'var(--color-primary, #818cf8)', border: '1px solid rgba(99,102,241,0.2)' }}
                >
                  👑 Admin
                </span>
              </div>
        ...
        <div style={glass} className="rounded-2xl overflow-hidden">
          ...
          <div className="p-6">
            <form onSubmit={handlePasswordSave} className="space-y-3">
              ...
              <button
                type="submit"
                className="w-full text-white py-2 rounded-xl text-sm font-semibold transition hover:opacity-90"
                style={{ background: 'linear-gradient(135deg, #3b82f6, #1e40af)', boxShadow: '0 4px 15px rgba(59,130,246,0.3)' }}
              >
                Update Password
              </button>
